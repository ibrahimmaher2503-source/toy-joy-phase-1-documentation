# Active Handoff — TSK-036 Final Party Settlement, Invoice, Receipt, Wallet, and Close Controls — 2026-08-07

TSK-036 is now active. First inspect `docs/28-party-operations-policy.md`, `docs/29-rental-asset-policy.md`, existing party final-close/invoice/payment/receipt/Party Wallet/credit/overpayment/readiness/approval/audit/idempotency/document-sequence/print contracts, and current party/payment/wallet UI. The authorized scope is Local/Dev discovery/readiness only: configurable `PENDING/TBD` final readiness, invoice freeze/close, reconciliation, credit/overpayment, Party Wallet settlement, receipt, approval, audit, idempotency, numbering, and print values, guarded empty/readiness UI, and bilingual browser evidence. No final invoice, receipt, settlement, wallet entry, credit, overpayment, close, posting, or financial mutation may be enabled.

TSK-035 is complete for its bounded Local/Dev damage/loss/maintenance/depreciation readiness slice; event creation, cost, approval, state transition, evidence, depreciation, correction, stock, and financial mutations remain blocked. UI-PTY-012 guide route registration was corrected after live detection; full Finish replay remains unverified after session reset.
