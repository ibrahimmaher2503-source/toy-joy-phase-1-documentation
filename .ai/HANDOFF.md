# Active Handoff — TSK-037 Standalone Retail and Party Quotations — 2026-08-07

TSK-037 is now active. First inspect `docs/35`, `docs/36`, `docs/37`, `docs/38`, existing quotation/proposal/customer/price/retail-party typing/expiry/terms/approval/audit/numbering/print/share/conversion contracts, and current retail/party UI. The authorized scope is Local/Dev discovery/readiness only: configurable `PENDING/TBD` quotation type, status, expiry, terms, price authority, customer/party linkage, approval, numbering, print/share, audit, and future conversion values, guarded empty/readiness UI, and bilingual browser evidence. No quote, approval, print/share, conversion, sale, party invoice, inventory, wallet, payment, or financial mutation may be enabled.

TSK-036 is complete for its bounded Local/Dev final settlement/close readiness slice; final invoice, receipt, settlement, Party Wallet, credit/overpayment, close, posting, and financial mutations remain blocked.
