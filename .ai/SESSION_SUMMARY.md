...
- **Code, tests, browser, commit, push:** Code implemented and browser-reviewed for the local empty-state slice; no PHPUnit/Pest or automated browser tests; commit/push pending final diff review; no push requested.
