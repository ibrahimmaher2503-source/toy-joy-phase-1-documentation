<?php
if (!function_exists('__c902cfe3a27f48fafc3dd2a326f9f172')):
function __c902cfe3a27f48fafc3dd2a326f9f172($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php __0ef6a38bec8617e0691200e9ecc57327($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => $iconClasses], [], ['icon', 'variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
        </div>
    <?php elseif ($icon): ?>
    ...
    <div class="ps-2 flex-1 <?php echo e($inline ? '@md:flex @md:[&>[data-slot="content"]:has([data-slot="heading"]):has([data-slot="text"])+[data-slot="actions"]]:p-2' : ''); ?>">
        <div class="flex-1 py-2 pe-3 @md:pe-4 flex flex-col justify-center gap-2" data-slot="content">
            <?php if ($heading): ?>
                <?php $__blaze->ensureRequired('C:\projects\toy-joy-phase-1-documentation\vendor\livewire\flux\src/../stubs/resources/views/flux/callout/heading.blade.php', $__blaze->compiledPath.'/4233c607a81460e859bca1aac0cb502d.php'); ?>
<?php if (isset($__slots4233c607a81460e859bca1aac0cb502d)) { $__slotsStack4233c607a81460e859bca1aac0cb502d[] = $__slots4233c607a81460e859bca1aac0cb502d; } ?>
<?php if (isset($__attrs4233c607a81460e859bca1aac0cb502d)) { $__attrsStack4233c607a81460e859bca1aac0cb502d[] = $__attrs4233c607a81460e859bca1aac0cb502d; } ?>
<?php $__attrs4233c607a81460e859bca1aac0cb502d = []; ?>
<?php $__slots4233c607a81460e859bca1aac0cb502d = []; ?>
<?php $__blaze->pushData($__attrs4233c607a81460e859bca1aac0cb502d); ?>
<?php ob_start(); ?><?php echo e($heading); ?><?php $__slots4233c607a81460e859bca1aac0cb502d['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slots4233c607a81460e859bca1aac0cb502d); ?>
<?php __4233c607a81460e859bca1aac0cb502d($__blaze, $__attrs4233c607a81460e859bca1aac0cb502d, $__slots4233c607a81460e859bca1aac0cb502d, [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack4233c607a81460e859bca1aac0cb502d)) { $__slots4233c607a81460e859bca1aac0cb502d = array_pop($__slotsStack4233c607a81460e859bca1aac0cb502d); } ?>
<?php if (! empty($__attrsStack4233c607a81460e859bca1aac0cb502d)) { $__attrs4233c607a81460e859bca1aac0cb502d = array_pop($__attrsStack4233c607a81460e859bca1aac0cb502d); } ?>
<?php $__blaze->popData(); ?>
            <?php endif; ?>

            <?php if ($text): ?>
                <?php $__blaze->ensureRequired('C:\projects\toy-joy-phase-1-documentation\vendor\livewire\flux\src/../stubs/resources/views/flux/callout/text.blade.php', $__blaze->compiledPath.'/5b531b75a577b4aefc24d8bc54872863.php'); ?>
<?php if (isset($__slots5b531b75a577b4aefc24d8bc54872863)) { $__slotsStack5b531b75a577b4aefc24d8bc54872863[] = $__slots5b531b75a577b4aefc24d8bc54872863; } ?>
<?php if (isset($__attrs5b531b75a577b4aefc24d8bc54872863)) { $__attrsStack5b531b75a577b4aefc24d8bc54872863[] = $__attrs5b531b75a577b4aefc24d8bc54872863; } ?>
<?php $__attrs5b531b75a577b4aefc24d8bc54872863 = []; ?>
<?php $__slots5b531b75a577b4aefc24d8bc54872863 = []; ?>
<?php $__blaze->pushData($__attrs5b531b75a577b4aefc24d8bc54872863); ?>
<?php ob_start(); ?><?php echo e($text); ?><?php $__slots5b531b75a577b4aefc24d8bc54872863['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slots5b531b75a577b4aefc24d8bc54872863); ?>
<?php __5b531b75a577b4aefc24d8bc54872863($__blaze, $__attrs5b531b75a577b4aefc24d8bc54872863, $__slots5b531b75a577b4aefc24d8bc54872863, [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack5b531b75a577b4aefc24d8bc54872863)) { $__slots5b531b75a577b4aefc24d8bc54872863 = array_pop($__slotsStack5b531b75a577b4aefc24d8bc54872863); } ?>
<?php if (! empty($__attrsStack5b531b75a577b4aefc24d8bc54872863)) { $__attrs5b531b75a577b4aefc24d8bc54872863 = array_pop($__attrsStack5b531b75a577b4aefc24d8bc54872863); } ?>
<?php $__blaze->popData(); ?>
            <?php endif; ?>
...
} endif; ?><?php /**PATH C:\projects\toy-joy-phase-1-documentation\vendor\livewire\flux\src/../stubs/resources/views/flux/callout/index.blade.php ENDPATH**/ ?>