<?php
if (!function_exists('_6a91a519a38a87a406dbbd994a3a115c')):
function _6a91a519a38a87a406dbbd994a3a115c($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH C:\projects\toy-joy-phase-1-documentation\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/clipboard-document-list.blade.php ENDPATH**/ ?>