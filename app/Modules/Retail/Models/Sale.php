...
{
    protected $fillable = ['branch_id', 'store_id', 'cash_drawer_id', 'shift_id', 'cashier_id', 'document_number', 'status', 'idempotency_key', 'subtotal', 'discount_total', 'tax_total', 'total', 'paid_total', 'change_total', 'currency_code', 'notes', 'approved_at', 'suspended_at', 'lock_version'];

    protected $casts = ['subtotal' => 'decimal:2', 'discount_total' => 'decimal:2', 'tax_total' => 'decimal:2', 'total' => 'decimal:2', 'paid_total' => 'decimal:2', 'change_total' => 'decimal:2', 'approved_at' => 'datetime', 'suspended_at' => 'datetime'];
