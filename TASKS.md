...
- **Task ID / Phase / Milestone / Status:** TSK-015; Phase 2; DM 2.2; **In Progress — Slice A schema, Performance Group A structural work, and a read-only readiness boundary are implemented locally; invoice posting/import, receipt mutation, WAC/cost rules, commercial defaults, and authenticated/browser acceptance remain gated**.
