        ...
        @if (! $store || ! $shift)
            <flux:callout variant="warning" icon="exclamation-triangle">
                <div class="flex flex-wrap items-center justify-between gap-3">
                    <span>{{ ! $store ? __('No selling store is assigned to this cashier.') : __('No open shift. Open a shift before completing a sale.') }}</span>
