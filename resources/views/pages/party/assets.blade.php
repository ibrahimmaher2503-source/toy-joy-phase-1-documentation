                ...
                @forelse($assets as $asset)
                    ...
                    <tr class="border-t border-zinc-100 dark:border-zinc-800 align-top">
                        ...
                        <td class="min-w-[270px] space-y-2">
                            @can('rental_assets.print')<flux:button size="sm" variant="subtle" href="{{ route('party.assets.print', $asset) }}">{{ __('History / print') }}</flux:button>@endcan
