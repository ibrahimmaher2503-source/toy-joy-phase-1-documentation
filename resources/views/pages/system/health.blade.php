...
use App\Actions\Platform\GetPlatformStatus;
use Flux\Flux;
...
<section class="w-full space-y-6">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex items-center gap-3">
            <flux:badge size="sm" variant="outline" icon="fingerprint" class="font-mono">
        ...
        <flux:table>
            ...
            <flux:table.rows>
                ...
                <flux:table.row>
                    ...
                    <flux:table.cell class="font-mono text-xs">{{ $status['request_id'] ?? '-' }}</flux:table.cell>
                ...
                <flux:table.row>
                    ...
                    <flux:table.cell class="font-mono text-xs">{{ $status['timestamp'] ?? '-' }}</flux:table.cell>
