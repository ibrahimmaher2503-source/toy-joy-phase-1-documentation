...
<body class="min-h-screen bg-zinc-50 text-zinc-900 antialiased dark:bg-zinc-900 dark:text-zinc-100 flex items-center justify-center p-4">
    <div class="max-w-md w-full bg-white dark:bg-zinc-800 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700 p-6 text-center space-y-6">
        <div class="mx-auto w-12 h-12 rounded-full bg-orange-100 dark:bg-orange-950/50 text-orange-600 dark:text-orange-400 flex items-center justify-center">
        ...
        <div class="space-y-2">
            <h1 class="text-xl font-bold tracking-tight">غير مصرح بالوصول</h1>
            <p class="text-xs text-zinc-500 dark:text-zinc-400 uppercase tracking-widest font-semibold">{{ app()->getLocale() === 'ar' ? '403' : 'Access denied (403)' }}</p>
        </div>

        <p class="text-sm text-zinc-600 dark:text-zinc-300 leading-relaxed">
            ليس لديك الصلاحية الكافية للوصول إلى هذه الصفحة أو تنفيذ هذا الإجراء.
        </p>
